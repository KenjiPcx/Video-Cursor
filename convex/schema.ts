...
const vTimelineData = v.array(v.object({
  ...
  items: v.array(v.object({
    ...
    assetId: v.optional(v.union(v.id("artifactAssets"), v.id("staticAssets"))), // Optional reference to asset in our database
